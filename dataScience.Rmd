---
title: "Data science to improve research quality, openness, reproducibility and efficiency at ICES"
subtitle: ""
author: "Doug Manuel"
date: "2018/11/08 (updated: `r Sys.Date()`)"
output:
  xaringan::moon_reader: # remark.js
    lib_dir: libs
    nature:
...
- Speechless colloborator/friend
  1) Git
  2) machine readible
  
- Our imperitive:
  1) web based algorithms.
  2) multiple uses of analytic output - reflecting more complex analyses.
  3) Research quality, transparency, reproduciblilty, efficiency.
    - can you replicate your own work? How easy is it for someone else to replicate your work.
    - how comfortable are you with the following statement:
      Much code is bug free and analysis output is correct?
  
- Constraints:
  1) ICES firewall. 
  2) Different team backgrounds.
  
- Other concepts
    - software engineering
      - Are you designing your code to work well? how do you know it works well? unit testing
      - Are you desiging your code to be used by others?  documentation.

- all notes are available in github.
- get your sticker by: 1) completing a quick anonomous survey; or 2) setting up a github account and commenting on an 'Issue"
